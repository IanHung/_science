...
ADMINS = (
     ('Ian Hung', 'ianmenghung@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_DIR, 'sqlite.db'),                      # Or path to database file if using sqlite3. Replace with: os.path.join(PROJECT_DIR, 'sqlite.db'), 
...
ROOT_URLCONF = '_science.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = '_science.wsgi.application'
