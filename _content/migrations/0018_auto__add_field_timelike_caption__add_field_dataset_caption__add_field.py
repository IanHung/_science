...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timelike.caption'
        db.add_column(u'_content_timelike', 'caption',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dataset.caption'
        db.add_column(u'_content_dataset', 'caption',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.caption'
        db.add_column(u'_content_image', 'caption',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Timelike.caption'
        db.delete_column(u'_content_timelike', 'caption')

        # Deleting field 'Dataset.caption'
        db.delete_column(u'_content_dataset', 'caption')

        # Deleting field 'Image.caption'
        db.delete_column(u'_content_image', 'caption')
