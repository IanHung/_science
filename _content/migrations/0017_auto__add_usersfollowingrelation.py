...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UsersFollowingRelation'
        db.create_table(u'_content_usersfollowingrelation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('primaryUser', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'_content', ['UsersFollowingRelation'])

        # Adding M2M table for field following on 'UsersFollowingRelation'
        m2m_table_name = db.shorten_name(u'_content_usersfollowingrelation_following')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('usersfollowingrelation', models.ForeignKey(orm[u'_content.usersfollowingrelation'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['usersfollowingrelation_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'UsersFollowingRelation'
        db.delete_table(u'_content_usersfollowingrelation')

        # Removing M2M table for field following on 'UsersFollowingRelation'
        db.delete_table(db.shorten_name(u'_content_usersfollowingrelation_following'))
