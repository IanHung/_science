...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StructureNode.isDraft'
        db.add_column(u'_content_structurenode', 'isDraft',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StructureNode.isDraft'
        db.delete_column(u'_content_structurenode', 'isDraft')
